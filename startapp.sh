#!/bin/bash
echo ""
echo "running: source $HOME/Documents/Projects/Coding_Dojo/brevedev/venv/bin/activate"
source "$HOME/Documents/Projects/Coding_Dojo/brevedev/venv/bin/activate"
